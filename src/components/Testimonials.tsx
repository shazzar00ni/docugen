    ...
    <section id="testimonials" className="py-20 bg-dark-900/30">
      <Container>
        <div className="text-center mb-16">
          <h2 className="text-3xl sm:text-4xl font-bold text-dark-50 mb-4">Loved by developers</h2>
        ...
        <div className="grid md:grid-cols-3 gap-6">
          {TESTIMONIALS.map((testimonial, index) => (
            ...
            >
              ...
              <p className="text-dark-300 mb-6 leading-relaxed">{testimonial.quote}</p>
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <p className="text-dark-100 font-medium text-sm">{testimonial.author}</p>
