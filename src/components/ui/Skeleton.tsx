...
export function Skeleton({ className = '', variant = 'text', width, height }: SkeletonProps) {
  const baseStyles = 'bg-light-200 dark:bg-light-800 animate-pulse rounded';
...
export function SkeletonCard() {
  return (
    <div className="bg-light-50 border border-light-200 dark:bg-light-950/50 dark:border-light-800 rounded-xl p-6">
...
export function SkeletonFeature() {
  return (
    <div className="bg-light-50 border border-light-200 dark:bg-light-950/50 dark:border-light-800 rounded-xl p-6 space-y-4">
      <Skeleton variant="circular" width={40} height={40} />
