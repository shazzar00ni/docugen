    ...
    <section className="py-20 bg-dark-900/30">
      <Container>
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-dark-400">Clean, modern, and blazing fast. Just like this.</p>
        </div>
            ...
            <div className="flex">
              <div className="w-64 bg-dark-900 border-r border-dark-800 p-4 hidden md:block">
                <div className="space-y-3">
                  <div className="text-xs font-semibold text-dark-500 uppercase tracking-wider">
                    Getting Started
                  </div>
                  <div className="space-y-1">
                    ...
                    <div className="px-3 py-2 text-sm text-dark-300 hover:text-dark-100 hover:bg-dark-800 rounded-md cursor-pointer transition-colors">
                      Quick Start
                    </div>
                    <div className="px-3 py-2 text-sm text-dark-300 hover:text-dark-100 hover:bg-dark-800 rounded-md cursor-pointer transition-colors">
                      Installation
                  ...
                  <div className="text-xs font-semibold text-dark-500 uppercase tracking-wider mt-4">
                    Core Concepts
                  </div>
                  <div className="space-y-1">
                    <div className="px-3 py-2 text-sm text-dark-300 hover:text-dark-100 hover:bg-dark-800 rounded-md cursor-pointer transition-colors">
