      ...
      <Container>
        <div className="flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <div className="flex items-center space-x-4">
            <a href="#" aria-label="GitHub" className="text-dark-400 hover:text-dark-100 transition-colors">
            ...
            <a href="#" aria-label="Twitter" className="text-dark-400 hover:text-dark-100 transition-colors">
              <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
